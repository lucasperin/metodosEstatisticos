...
summary(data$Idade)
print("Variância")
print(var(data$Idade))
print("====AMOSTRAS=====")

printSample(samplefy(data$Idade, 20), 20, "Média de uma amostra com 20 dados", data$Idade)
#printSample(samplefy(data$Idade, 100), 100, "Média de uma amostra com 100 dados", data$Idade)
